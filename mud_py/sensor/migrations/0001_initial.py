    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('controlnode', models.ForeignKey(blank=True, default=None, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='assignedsensors', to='controlnode.controlnode')),
            ],
        ),
        migrations.CreateModel(
            name='SensorDataUnit',
        ...
        migrations.AddField(
            model_name='sensor',
            name='location',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='sensor.sensorlocation'),
        ),
        migrations.AddField(
            model_name='sensor',
            name='zone',
